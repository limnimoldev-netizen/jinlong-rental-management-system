...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="/properties/create" class="bg-primary text-secondary px-4 py-2 rounded-lg flex items-center gap-2">
                ...
                <tr class="border-b">
                    <td class="px-4 py-2">
                        <div class="flex items-center gap-3">
                            <img src="{{ asset('images/' . $property->image) }}" alt="{{ $property->name }}" class="w-12 h-12 rounded-lg object-cover">
                            <div>
                                <div class="font-medium">{{ $property->name }}</div>
                                <div class="text-gray-500 text-sm">{{ $property->address ?? 'N/A' }}</div>
                            </div>
                        </div>
                    </td>
